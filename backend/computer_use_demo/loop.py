...
async def sampling_loop(
    *,
    ...
    output_callback: Callable[[BetaContentBlockParam], Awaitable[None]],
    tool_output_callback: Callable[[ToolResult, str], Awaitable[None]],
    api_response_callback: Callable[
        [httpx.Request, httpx.Response | object | None, Exception | None], Awaitable[None]
    ],
    api_key: str,
    ...
    while True:
        ...
        for content_block in response_params:
            # Always call output callback for all content blocks
